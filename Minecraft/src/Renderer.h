...
private:
    ...
    void draw_block_mesh(set_of_chunks &chunks4rendering, Light &light, glm::mat4 &projection_view,
                         sf::Vector3i &player_pos);

    void
    draw_water_mesh(set_of_chunks &chunks4rendering, Light &light, glm::mat4 &projection_view, sf::Vector3i &player_pos,
                    Player &player);

    static glm::fvec3 calc_global_pos(const sf::Vector3i &chunk_pos, const sf::Vector3i &player_pos);
